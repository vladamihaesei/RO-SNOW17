...
intended for use at a point location. This code is writen in R programming language, converted from MATLAB code written by by Mark Raleigh (mraleig1@uw.edu) based on Anderson (2006).  The time steps for precipitation
