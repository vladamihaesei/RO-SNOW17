...
PARAMS <- expand.grid(SCF = 1, UADJ = 0.02, MBASE = seq(-1,2,.2), MFMAX = 1.05, MFMIN = 0.60,TIPM = 0.2, NMF = 0.1, PLWHC = 0.04,
...
sSETTINGS <- expand.grid(RvS = 0, mDEC_RHO_COMPACTION = c(1), mDEC_RHO_DM_METAMORPH = 1, mDEC_RHO_NEW = 0, mDEC_RHO_METHOD = 0) 
